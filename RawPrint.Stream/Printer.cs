...
namespace RawPrint.Stream
{
    public class Printer : IPrinter
    {
        ...
        public void PrintRawStream(string printer, MemoryStream stream, string documentName, bool paused)
        {
            PrintRawStream(printer, stream, documentName, paused, 1);
        }

        public void PrintRawStream(string printer, MemoryStream stream, string documentName, bool paused, int pagecount)
        {
